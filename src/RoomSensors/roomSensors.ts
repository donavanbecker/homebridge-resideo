...
export class RoomSensors {
  ...
  constructor(
    ...
    this.service = this.accessory.getService(this.platform.Service.BatteryService) ||
      this.accessory.addService(this.platform.Service.BatteryService), `${this.sensoraccessory.accessoryAttribute.name} Room Sensor`;
    ...
    this.service.setCharacteristic(this.platform.Characteristic.Name, `${this.sensoraccessory.accessoryAttribute.name} Room Sensor`);
    ...
    if (!this.temperatureService && !this.platform.config.options.roomsensor.hide_temperature) {
      this.temperatureService = accessory.addService(this.platform.Service.TemperatureSensor, `${this.sensoraccessory.accessoryAttribute.name} Temperature Sensor`);
    ...
    if (!this.occupancyService && !this.platform.config.options.roomsensor.hide_occupancy) {
      this.occupancyService = accessory.addService(this.platform.Service.OccupancySensor, `${this.sensoraccessory.accessoryAttribute.name} Occupancy Sensor`);
    ...
    if (!this.humidityService && !this.platform.config.options.roomsensor.hide_humidity) {
      this.humidityService = accessory.addService(this.platform.Service.HumiditySensor, `${this.sensoraccessory.accessoryAttribute.name} Humidity Sensor`);
    ...
    if (!this.motionService && !this.platform.config.options.roomsensor.hide_motion) {
      this.motionService = accessory.addService(this.platform.Service.MotionSensor, `${this.sensoraccessory.accessoryAttribute.name} Motion Sensor`);
  ...
  async refreshStatus() {
    try {
      ...
      this.platform.log.error(`Failed to update status of ${this.sensoraccessory.accessoryAttribute.name} ${this.sensoraccessory.accessoryAttribute.type}`, e.message);
    }
  }
  ...
  handeStatusLowBatteryGet(callback: (arg0: null, arg1: any) => void) {
    this.platform.log.warn(`Update Battery Status: ${this.StatusLowBattery}`);
  ...
  handleCurrentTemperatureGet(callback: (arg0: null, arg1: any) => void) {
    this.platform.log.warn(`Update Current Temperature: ${this.CurrentTemperature}`);
  ...
  handleOccupancyDetectedGet(callback: (arg0: null, arg1: any) => void) {
    this.platform.log.warn(`Update Occupancy: ${this.OccupancyDetected}`);
  ...
  handleCurrentRelativeHumidityGet(callback: (arg0: null, arg1: any) => void) {
    this.platform.log.warn(`Update Current Relative Humidity: ${this.CurrentRelativeHumidity}`);
  ...
  handleMotionDetectedGet(callback: (arg0: null, arg1: any) => void) {
    this.platform.log.warn(`Update Motion: ${this.MotionDetected}`);
